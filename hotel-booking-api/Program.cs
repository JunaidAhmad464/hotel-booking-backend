using HodHodBackend.Context.DataSeeding;
using HodHodBackend.Helpers.JwtConfigurations;
using HodHodBackend.Services.AuthenticationServices;
using HodHodBackend.Services.RoleManagementServices;
using HodHodBackend.Services.UserManagementServices;
using hotel_booking_api;
using hotel_booking_api.Helpers;
using hotel_booking_api.Helpers.JWTConfiguration;
...
builder.Services.AddIdentity<ApplicationUser, ApplicationRole>(
    ...
    }).AddEntityFrameworkStores<HotelBookingContext>().AddDefaultTokenProviders();
